...
public class SecondActivity extends AppCompatActivity {
    ...
    public void userLogout(){
        Intent intentLogout = new Intent(SecondActivity.this, LoginActivity.class);
        startActivity(intentLogout);
        finish();
        Toast.makeText(SecondActivity.this, "Logged out successfully", Toast.LENGTH_LONG).show();
    }
}